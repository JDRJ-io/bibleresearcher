...
function HeaderCell({ column, isMain, isMobile }: HeaderCellProps) {
  ...
  const getAdaptiveStyle = () => {
    ...
    if (screenSize === "mobile") {
      switch (column.slot) {
        case 0:
          return { width: "24px" }; // Reference - w-6 (24px)
        case 1:
          return { width: "80px" }; // Notes - w-20 (80px)
        case 2:
          return { width: "208px" }; // Main translation - w-52 (208px)
        case 7:
          return { width: "208px" }; // Cross References - w-52 (208px)
        case 8:
        case 9:
        case 10:
          return { width: "200px" }; // Prophecy P/F/V - w-[200px]
        case 11:
          return { width: "24px" }; // Dates - w-20 (80px)
        default:
          return { width: "160px" }; // Alt translations - w-40 (160px)
      }
    } else if (screenSize === "tablet") {
      switch (column.slot) {
        case 0:
          return { width: "80px" }; // Reference - w-20 (80px)
        case 1:
          return { width: "192px" }; // Notes - w-48 (192px)
        case 2:
          return { width: "256px" }; // Main translation - w-64 (256px)
        case 7:
          return { width: "256px" }; // Cross References - w-64 (256px)
        case 8:
        case 9:
        case 10:
          return { width: "200px" }; // Prophecy P/F/V - w-[200px]
        case 11:
          return { width: "200px" }; // Dates - w-24 (96px)
        default:
          return { width: "256px" }; // Alt translations - w-64 (256px)
      }
    } else {
      // desktop
      switch (column.slot) {
        case 0:
          return { width: "80px" }; // Reference - w-20 (80px)
        case 1:
          return { width: "256px" }; // Notes - w-64 (256px)
        case 2:
          return { width: "320px" }; // Main translation - w-80 (320px)
        case 7:
          return { width: "320px" }; // Cross References - w-80 (320px)
        case 8:
        case 9:
        case 10:
          return { width: "200px" }; // Prophecy P/F/V - w-[200px]
        case 11:
          return { width: "200px" }; // Dates - w-30 (120px)
        default:
          return { width: "320px" }; // Alt translations - w-80 (320px)
      }
    }
  };
  ...
  const textClass =
    column.name === "Ref" || column.name === "Reference" || column.name === "#"
...
export function ColumnHeaders({
  ...
  alternates.forEach((translationCode, index) => {
    ...
    if (slot <= 6) {
      // Max 4 alternate translations (slots 3-6)
      slotConfig[slot] = {
  ...
  // Debug logging
  console.log(
    "📋 ColumnHeaders slotConfig:",
    Object.keys(slotConfig).map((slot) => ({
      slot: parseInt(slot),
  ...
  const shouldCenter =
    !adaptiveIsMobile &&
    viewportWidth >= 1000 &&
    estimatedTotalWidth <= viewportWidth * 0.95;
  ...
  const topHeaderHeight = adaptiveIsMobile ? 48 : 0;   // Mobile: 48px to account for top header, Desktop: 0 (no offset needed)
