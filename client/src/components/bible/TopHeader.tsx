...
import { ChevronLeft, ChevronRight, Search, Menu, Sparkles, KeyRound, X, Book, Bookmark, FileText } from 'lucide-react';
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 rounded-full bg-blue-50/80 dark:bg-blue-900/30 
                             border-2 border-blue-400/60 dark:border-blue-500/50 flex items-center justify-center relative overflow-hidden backdrop-blur-sm">
