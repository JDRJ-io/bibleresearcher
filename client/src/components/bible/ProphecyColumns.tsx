...
function ProphecyRow({ verseKey, onVerseClick, mainTranslation }: { 
  ...
  if (isLoading) {
    return (
      <div className="flex h-full">
        ...
        <div className="w-[1200px] flex-shrink-0 border-r p-2">
        ...
        <div className="w-[1200px] flex-shrink-0 p-2">
  ...
  return (
    <div className="flex h-full">
      ...
      <div className="w-[1200px] flex-shrink-0 border-r p-2 overflow-y-auto">
        <div className="text-xs font-bold text-blue-600 dark:text-blue-400 mb-2">Prediction</div>
      ...
      <div className="w-[1200px] flex-shrink-0 p-2 overflow-y-auto">
        <div className="text-xs font-bold text-purple-600 dark:text-purple-400 mb-2">Verification</div>
        {prophecies.map((prophecy) => (
          <ProphecyBlock
            key={`V-${prophecy.id}`}
