...
export const THEMES: Record<ThemeName, ThemeVars> = {
  ...
  electric: {
    bgPrimary: 'hsl(215, 95%, 8%)',
    bgSecondary: 'hsl(218, 90%, 6%)',
    headerBg: 'hsl(215, 95%, 8%)',
    columnBg: 'hsl(215, 95%, 8%)',
    highlightBg: 'hsla(60, 100%, 50%, 0.15)',
    gradAngle: '135deg',
    grad0: 'hsl(216, 100%, 12%)',
    grad1: 'hsl(214, 95%, 15%)',
    glassBg: 'rgba(10, 20, 60, 0.25)',
    textPrimary: 'hsl(50, 100%, 90%)',
    textSecondary: 'hsl(45, 80%, 75%)',
    borderColor: 'hsl(215, 80%, 25%)',
